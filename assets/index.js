...
var products = document.getElementById('#products-list'); // both product & quantity var's should append synomymously on the same row
var quantity = document.getElementById('#products-quantity'); // list should line up with the products variable on the same row
